...
@section('contenido')
    ...
    <div class="container mx-auto lg:my-64 my-24 ">
            ...
            <form action="{{route('youtube.store')}}" method="POST" enctype="multipart/form-data" class="w-11/12 max-w-5xl border rounded-2xl bg-white mx-auto ">
                @csrf 
                <div class="my-2 lg:my-6 ">
                    <h3 class="text-center font-bold text-2xl lg:text-3xl" >Subir nuevo Enlace Youtube</h3>
                </div>
